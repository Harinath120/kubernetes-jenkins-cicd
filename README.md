...
cd-jenkins-85b6c95746-ng9jh   1/1       Running   0          3m
```
...
cd-jenkins         ClusterIP   10.35.246.103   <none>        8080/TCP    11m
cd-jenkins-agent   ClusterIP   10.35.245.24    <none>        50000/TCP   11m
